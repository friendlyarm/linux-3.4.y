...
#if defined(CONFIG_TOUCHSCREEN_ATMEL_MXT224S) //1112
...
#elif defined(CONFIG_TOUCHSCREEN_ATMEL_MXT640T)
#define MXT_DEV_NAME	"Atmel MXT640T"
#define MXT_DEFAULT_FIRMWARE_NAME	"mxt640t.fw"
#define MXT_SMAC_FIRMWARE_NAME	"mxt640t_s.fw"
#define MXT_TRAIS_FIRMWARE_NAME	"mxt640t_t.fw"
...
#elif defined(CONFIG_TOUCHSCREEN_ATMEL_MXT2952T)
#define MXT_DEV_NAME	"Atmel MXT2952T"
#define MXT_DEFAULT_FIRMWARE_NAME	"mXT2952T.fw"
#else
...
#define MXT_BOOT_LOW	0x26	//For T seriese
...
#define MXT_CONFIG_VERSION_LENGTH	8 //1108
...
#define TSP_PATCH				1
#define DEBUG_TSP				1
#define TSP_BOOSTER				0   // bitpark remove  dvfs for exynos
#define TSP_SEC_FACTORY			0   // bitpark remove
#define PALM_CAL				0

#define TSP_INFORM_CHARGER		0  // bitpark remove for test , we need mxt_tsp_register_callback() function body 
#define TSP_USE_SHAPETOUCH		0
#define ENABLE_TOUCH_KEY		0      // bitpark remove
...
struct mxts_callback {
	struct notifier_block mxts_nb;
	void (*inform_charger)(struct mxts_callback *, bool);
};
...
//	void (*register_cb) (struct mxts_callback *);
#if ENABLE_TOUCH_KEY
