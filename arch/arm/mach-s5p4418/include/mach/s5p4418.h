...
#define TIEOFF_UART1_USERSMC		TIEOFFINDEX_OF_UART_MODEM0_USESMC
#define TIEOFF_UART1_SMCTXENB		TIEOFFINDEX_OF_UART_MODEM0_SMCTXENB
#define TIEOFF_UART1_SMCRXENB		TIEOFFINDEX_OF_UART_MODEM0_SMCRXENB
#define TIEOFF_UART2_USERSMC		TIEOFFINDEX_OF_UART1_USESMC
#define TIEOFF_UART2_SMCTXENB		TIEOFFINDEX_OF_UART1_SMCTXENB
#define TIEOFF_UART2_SMCRXENB		TIEOFFINDEX_OF_UART1_SMCRXENB
#define TIEOFF_UART3_USERSMC		TIEOFFINDEX_OF_UART_NODMA0_USESMC
#define TIEOFF_UART3_SMCTXENB		TIEOFFINDEX_OF_UART_NODMA0_SMCTXENB
#define TIEOFF_UART3_SMCRXENB		TIEOFFINDEX_OF_UART_NODMA0_SMCRXENB
#define TIEOFF_UART4_USERSMC		TIEOFFINDEX_OF_UART_NODMA1_USESMC
#define TIEOFF_UART4_SMCTXENB		TIEOFFINDEX_OF_UART_NODMA1_SMCTXENB
#define TIEOFF_UART4_SMCRXENB		TIEOFFINDEX_OF_UART_NODMA1_SMCRXENB
#define TIEOFF_UART5_USERSMC		TIEOFFINDEX_OF_UART_NODMA2_USESMC
#define TIEOFF_UART5_SMCTXENB		TIEOFFINDEX_OF_UART_NODMA2_SMCTXENB
#define TIEOFF_UART5_SMCRXENB		TIEOFFINDEX_OF_UART_NODMA2_SMCRXENB
