...
#endif
#define HDMI_PHY_BASE(x)        ((x) + OTHER_ADDR_OFFSET + 0x00000400)
#define HDMI_CEC_BASE(x)        ((x) + OTHER_ADDR_OFFSET + 0x00000000)
#define HDMI_AES_BASE(x)        ((x) + OTHER_ADDR_OFFSET + 0x00020000)

/* Control registers */
#define HDMI_INTC_CON_0			HDMI_CTRL_BASE(0x0000)
#define HDMI_INTC_FLAG_0		HDMI_CTRL_BASE(0x0004)
#define HDMI_HDCP_KEY_LOAD		HDMI_CTRL_BASE(0x0008) // HDMI_LINK_AESKEY_VALID
...
#define HDMI_CEC_IRQ_CLEAR		    HDMI_CEC_BASE(0x0014)
